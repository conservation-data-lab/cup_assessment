...
Using [LANDFIRE Existing Vegetation Type](https://landfire.gov/evt.php) data, we mapped and quantified patterns of the most dominant ecosystems in the central Upper Peninsula as of 2022.  For clarity all ecosystems not mapped. Lists and quantities of all ecosystems are available by contacting Randy Swaty (rswaty@tnc.org).  
