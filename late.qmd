...
Here we explore 'late-succession' habitat as defined by LANDFIRE in the [Biophysical Settings (BpS) models and descriptions](https://landfire.gov/bps-models.php){target=0} which is specifically defined for each BpS (historical ecosystem).
...
We strongly recommend reading the full report, available [here](https://www.fs.usda.gov/sites/default/files/mature-and-old-growth-forests-tech.pdf){target=0}, and exploring the [data viewer](https://experience.arcgis.com/experience/37cb7e33db6949c79f1f87f87968e51a/page/Simple-View/){target=0}.

### Mature and Old-Growth mapping effort by Barnett et al. (2023)

In a recently published [paper](https://www.frontiersin.org/articles/10.3389/ffgc.2022.1070372/full){target=0}, Barnett et al. (2023) classified, inventoried and mapped mature and old-growth (MOG) forests for the US.  Whereas many MOG mapping attempts use some combination of tree height and/or age and/or density, the authors assessed carbon accumulation, and assumed (briefly) that old-growth occurred:
...
At time of this assessment, raw data was not available for further assessment to our knowledge. However from [Figure 8](https://www.frontiersin.org/files/Articles/1070372/ffgc-05-1070372-HTML/image_m/ffgc-05-1070372-g008.jpg){target=0} in the paper a few patterns jump out:
...
Authors of this [paper](https://www.frontiersin.org/articles/10.3389/ffgc.2022.979528/full){target=0} used combinations of forest canopy height, cover and above-ground living biomass to map mature and old-growth forests (among many other things).  To summarize, the authors held workshops with scientists to develop 'rulesets' or thresholds of the three aforementioned parameters for each of 28 forest types groups, then combined the necessary datasets to map mature and old-growth forests.  
...
* There are robust descriptions and ecological models for each ecosystem that have been peer reviewed.  Learn more about the process from [Blankenship et al., (2021)](https://esajournals.onlinelibrary.wiley.com/doi/pdf/10.1002/ecs2.3484){target=0}, and [Swaty et al., (2021)](https://www.mdpi.com/2073-445X/11/1/28/pdf){target=0}. 
...
The Biden-Harris Administration released an Executive Order [‘Strengthening the Nation’s Forests, Communities, and Local Economies’](https://www.whitehouse.gov/briefing-room/presidential-actions/2022/04/22/executive-order-on-strengthening-the-nations-forests-communities-and-local-economies/){target=0} which mandates the Department of Agriculture and the Department of the Interior to inventory and publicly disclose information about old-growth and mature forests on Federal lands. 