...
This web report was developed by Liv, Nick, Silas and Randy of the [Conservation Data Lab](https://conservationdatalab.org/){target=0} and [Northern Michigan University](https://nmu.edu/){target=0} with the following goals:

* Support planning efforts by the [Marquette County Planning, Community Development, Forestry and Recreation Division](https://www.co.marquette.mi.us/departments/planning/index.php){target=0} 
* Practice GitHub, R, QGIS and ArcGIS Pro techniques
* Contribute to conservation in the central Upper Peninsula in general.

## Acknowledgements

We'd like to first acknowledge Robert Zeil (aka 'Zeke') who introduced us to, and taught Silas how to implement the Wildfire Exposure Risk calculations.  Learn more about Zeke at [https://www.linkedin.com/in/robertziel/](https://www.linkedin.com/in/robertziel/){target=0} and (https://wildfiretoday.com/2020/05/06/robert-ziel-receives-paul-gleason-lead-by-example-award/)[https://wildfiretoday.com/2020/05/06/robert-ziel-receives-paul-gleason-lead-by-example-award/]{target=0}.
...
1. Selected the 6 central-most counties from the [Census Bureau County Dataset (500m)](https://www.census.gov/geographies/mapping-files/time-series/geo/carto-boundary-file.html){target=0}.  Exported this data as a shapefile.
2. Used the 'Select by Location' tool with the U.S. HUC 8 Watershed Boundary from [Data Basin](https://databasin.org/maps/0f726f5eed644715ba119446f0cec417/){target=0} and the 6 selected CUP counties as the 'Selecting Features'.  Data exported as a shapefile, projected to the NAD 1983 coordination system (WKID 5070). 
...
* [LANDFIRE Existing Vegetation Type - Ecological Systems](https://landfire.gov/vegetation/evt){target=0} (EVT) for the 'Ecosystems' and 'Wildfire Exposure' tabs.
...
* [LANDFIRE Biophysical Settings Reference Conditions Table](https://landfire.gov/vegetation/bps-models){target=0} for the 'Late Succession' tab.
...
2. Used the ['Join field'](https://pro.arcgis.com/en/pro-app/latest/tool-reference/data-management/join-field.htm){target=0} tool in ArcGIS pro to attach  relevant attributes. 
